...
namespace InfirmerieGUI
{
    public partial class FrmModifierMedicament : Form
    {
        ...
        public FrmModifierMedicament(int id)
        {
            InitializeComponent();
            ...
            requeteComparaison = GestionMedicaments.VerifMedicament(id);
            ...
            else
            {
                ...
                unMedicament = GestionMedicaments.ExtractInfosMedicament(id);
        ...
        private void btnValider_Click(object sender, EventArgs e)
        {
            ...
            int requeteUpdateReussi = GestionMedicaments.ModifierMedicament(int.Parse(txtIdMedicament.Text), txtNomMedicament.Text, ckbArchive.Checked);
        ...
        private void btnSuppression_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(this, "Confirmez-vous la suppression du médicament ?", "Votre attention est requise !", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
                {
                    MessageBox.Show("Le médicament " + txtNomMedicament.Text + " a bien été supprimé !");
